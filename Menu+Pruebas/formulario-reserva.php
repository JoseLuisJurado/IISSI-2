            ...
            <fieldset>
                ...
                <fieldset class="margenGeneral">
					...
					?>
                        ...
                        <label>
                            Código Postal: <input type="text" name="CódigoPostal" placeholder="12345"
                    ...
                    <section class="margenGeneral">
                        ...
                        <label>
                            Correo electrónico: <input type="text" name="Correo electrónico" class="margenSexo"
                                pattern="[a-ze-9._$+-1+@[a-ze-9.-]+\-[a-z]{2,}" placeholder="aaaa@buscador.com"
                                required>
                        </label>
                        <label>
                            Correo electrónico Padre: <input type="text" name="CorreoPadre"
                                pattern="[a-ze-9._$+-1+@[a-ze-9.-]+\-[a-z]{2,}" placeholder="aaaa@buscador.com">
                        </label>
                    </section>
                    <section>
                        <label>
                            Fecha de llegada: <input type="datetime-local" name="FechaLLegada" class="margenGeneral"
                                required>
                        </label>
                    </section>
                    <section>
                        <label>
                            Fecha de salida: <input type="datetime-local" name="FechaSalida" class="margenGeneral"
                                required>
                        </label>
                    </section>
                    <section class="margenGeneral">
