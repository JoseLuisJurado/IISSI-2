...
<body>
    ...
    <div class="cuerpo2">
        ...
        <div class="cuerpo3">
            ...
            <img class="imagen" style="float: left; margin-right:1%; " src="imagenes/fachada1.jpg" border="2"
                width="300" height="200" />
            <p style="text-align: inherit"> Se estableció en la calle S.Alejandro, 179, con lo imprescindible, y tan
            ...
            <p style="text-align: inherit"> Alberto Rodriguez Guzmán, hombre vinculado a la Institución Libre de
            ...
            <p style="text-align: inherit"> Junto a Rodriguez Guzmán, la JAE puso como vocales de su Patronato, según
            ...
            <p style="text-align: inherit">Actualmente la residencia cuenta con un aforo superior a los 400 residentes,
            ...
            <p style="text-align: inherit">Premida en 2004 por su calidad como centro y en 2010 por su antigüedad es una
                de las mejores elecciónes
                para pasar en ella tus dias como
                estudiante univeritario o para disfrutar de unos diás en su maravillosas instalaciones con un estilo
                entre moderno y clasico que te
                soprendera agradablemente. Te esperamos con las puertas abiertas. </p>

            <a href="ResidenciaIISSI2.html">
                <img class="imagen2" style="margin-top:4%; margin:2% auto; display:block; "
                    src="imagenes/panoramica1.jpg" border="2" width="600" height="200" />
            </a>
